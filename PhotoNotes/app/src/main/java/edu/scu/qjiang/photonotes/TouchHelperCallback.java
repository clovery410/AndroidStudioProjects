...
public class TouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public TouchHelperCallback(MyRecyclerAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder source, RecyclerView.ViewHolder target) {
        Log.i("jsun", "item moved from " + source.getAdapterPosition() + " to " + target.getAdapterPosition());
        return mAdapter.onItemMove(source.getAdapterPosition(), target.getAdapterPosition());
    }

    @Override
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        Log.i("jsun", "item at " + viewHolder.getAdapterPosition() + " is swiped away");
